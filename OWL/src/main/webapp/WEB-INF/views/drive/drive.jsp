...
-------------------------------------------------------------- */
		...
		.directory-list .topFolder,
		.directory-list .topFolder>a {
			color: #777;
			font-weight: bold;
		}
	...
	<div class="row">
		<div class="col-md-3" style="padding-right: 0;">
			<div class="box">
				...
				<a href="Trash.do" id="trash" style="color:#4f5052; cursor: pointer;"><span style="color:#326295;"><i
							class="fas fa-trash-alt"></i></span>&nbsp;&nbsp;휴지통</a>
			</div>
		</div>
		...
		<div class="col-md-9" style="padding-left: 0;">
			<div class="drivemenu">
				...
				<button type="button" class="btn btn-primary" data-toggle="modal"
					data-target="#newFolder">새폴더</button>&nbsp;&nbsp;&nbsp;&nbsp;
