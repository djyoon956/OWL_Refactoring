...
<input type="hidden" id="opneJoinOkModal" data-toggle="modal" data-target="#joinOkModal">
<div class="modal fade" id="joinOkModal" tabindex="-2" role="dialog" aria-hidden="true">
