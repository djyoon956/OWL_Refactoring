										...
										<div class="modal-body">
												...
												<div class="form-group ">
													<div class="form-check form-check-inline">
														<label class="form-check-label"> <input
															...
															id="deleteChk"> <code>*</code>I agree. <span
															class="text-danger" style="display: block;">&emsp;Please
											...
											<form action="DeleteAccount.do" method="post">
												<input type="hidden" name="email" class="form-control email" value="${member.email}">
													...
													<button type="submit" class="btn btn-dark w-100"id="deleteMemberBtn">Close Account</button>
											</form>
										</div>
									</div>
								</div>
