...
<body>
	...
	<div class="page-wrapper" style="margin-left: 0; width: 100%; ; height:470px;">
			<div class="offset-1">
			<img src="resources/images/kanbanExample.png" height="278px;" class="float-right" style="margin-right:8.33333%;  box-shadow:0 10px 20px rgba(74,115,159,0.29); border-radius: 1rem; padding:4px;" >
